...
var RecognizerEngine = /** @class */ (function () {
  ...
  RecognizerEngine.prototype.defineRule = function (ruleName, impl, config) {
    ...
    // Lexical scoping to maintain the context
    const invokeRuleWithTry = (args) => {
      try {
    ...
    wrappedGrammarRule = (idxInCallingRule = 0, args) => {
      this.ruleInvocationStateUpdate(shortName, ruleName, idxInCallingRule);
      return invokeRuleWithTry(args);
    };
  ...
  RecognizerEngine.prototype.subruleInternal = function (
    ...
    try {
      ...
      ruleResult = ruleToCall(idx, args);
      that.cstPostNonTerminal(
        ruleResult,
      ...
      thats.subruleInternalError(e, options, ruleToCall.ruleName);
    }
  };
  ...
  RecognizerEngine.prototype.consumeInternalRecovery = function (
    ...
    if (
      ...
      try {
        ...
        if (
          eFromInRuleRecovery.name === recoverable_1.IN_RULE_RECOVERY_EXCEPTION
        ) {
